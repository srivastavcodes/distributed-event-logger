...
const file_api_v1_log_proto_rawDesc = "" +
	...
	"\x06record\x18\x02 \x01(\v2\x0e.log.v1.RecordR\x06record\"8\n" +
	"\x06Record\x12\x16\n" +
	...
	"\rProduceStream\x12\x16.log.v1.ProduceRequest\x1a\x17.log.v1.ProduceResponse\"\x00(\x010\x01B\n" +
	"Z\b./api/v1b\x06proto3"
